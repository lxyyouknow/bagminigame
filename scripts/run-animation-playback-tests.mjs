...
const outDir = ".tmp/animation-playback-tests";
...
await run("npx", [
  ...
  "tests/animation-playback-controller.test.ts", "src/scenes/animationPlaybackController.ts",
]);
await run("node", [`${outDir}/tests/animation-playback-controller.test.js`]);
