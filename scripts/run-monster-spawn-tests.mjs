...
const outDir = ".tmp/monster-spawn-tests";
...
await run("npx", [
  ...
  "tests/monster-spawn-rules.test.ts", "src/scenes/monsterSpawnRules.ts",
]);
await run("node", [`${outDir}/tests/monster-spawn-rules.test.js`]);
