...
const outDir = ".tmp/monster-attack-distance-tests";
...
await run("npx", [
  ...
  "tests/monster-attack-distance-rules.test.ts", "src/scenes/monsterAttackDistanceRules.ts",
]);
await run("node", [`${outDir}/tests/monster-attack-distance-rules.test.js`]);
