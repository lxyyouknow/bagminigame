...
const outDir = ".tmp/weapon-attack-tests";
...
await run("npx", [
  ...
  "tests/weapon-attack-rules.test.ts", "src/scenes/weaponAttackRules.ts",
]);
await run("node", [`${outDir}/tests/weapon-attack-rules.test.js`]);
