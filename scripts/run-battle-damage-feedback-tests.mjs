...
const outDir = ".tmp/battle-damage-feedback-tests";
...
await run("npx", [
  ...
  "tests/battle-damage-feedback-rules.test.ts", "src/scenes/battleDamageFeedbackRules.ts",
]);
await run("node", [`${outDir}/tests/battle-damage-feedback-rules.test.js`]);
