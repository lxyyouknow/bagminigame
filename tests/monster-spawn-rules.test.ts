...
const boss = chooseMonsterSpawnPosition(width, spawned, () => 0.95, 16, "center");
assert(Math.abs(boss.x - width / 2) <= 1, "Boss 应固定从中间出生");
assert(boss.y === 126, "Boss 中路出生纵坐标也应固定，避免每次刷出上下飘");
